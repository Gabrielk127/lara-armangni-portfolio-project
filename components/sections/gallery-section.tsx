...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/mono-1.png", alt: "Projeto arquitetônico ao nascer do sol" },
    { src: "/images/mono-2.png", alt: "Projeto arquitetônico durante o dia" },
    { src: "/images/mono-3.png", alt: "Projeto arquitetônico ao entardecer" },
    { src: "/images/mono-4.png", alt: "Projeto arquitetônico à noite" },
  ];
